...
class SpeechValidatorSpecs
  ...
  "run 'SpeechValidator' tests" should {
    ...
    "return true when urls are valid" in {
      SpeechValidator.isValidUrl("https://stackoverflow.com/questions/48717646/docker-compose-down-with-a-non-default-yml-file-name") shouldBe true
    ...
    "return false when urls are invalid" in {
      SpeechValidator.isValidUrl("https:stackoverflow.com/questions/48717646/docker-compose-down-with-a-non-default-yml-file-name") shouldBe false
