DROP DATABASE IF EXISTS fashion_digital_assignment_test; --this is test db
CREATE DATABASE fashion_digital_assignment_test;
\connect fashion_digital_assignment_test
